((context) => {
    ...
    return {
        name: "Kho Phần Mềm",
        icon: `<svg viewBox="0 0 24 24"><path fill="white" d="M12 2l-5.5 9 5.5 9 5.5-9L12 2zm0 3.84L15.13 11 12 14.16 8.87 11 12 5.84zM2 22h20v-2H2v2zm0-4h2v-8H2v8zm18-8h2v8h-2v-8z"/></svg>`,
        bgColor: "#2563eb", 
        action: runTool
    };
})
