...
((context) => {
    ...
    return {
        name: "Thông báo",
        icon: `<svg viewBox="0 0 128 128"><path d="M93.43 98.52s-23.66-6.21-41.21 10.42c-7.55 7.16-12.89 12.47-14.18 13.76c-4.03 4.03-14.4 2.96-24.47-7.11s-11.63-22.1-7.6-26.12c.6-.6 7.34-6.59 14.82-14.5c7.99-8.46 6.55-20.27 7.06-27.56c.61-8.76 2.22-12.23 2.22-12.23l63.36 63.34z" fill="#8cafbf"/></svg>`,
