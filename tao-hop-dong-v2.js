    ...
    const runTool = () => {
        ...
        if (!app) {
                        ...
                        <div class="con-row" style="gap:15px;">
                            ...
                            <div class="con-col con-group" style="min-width: 200px;">
                                ...
                                <select id="con-file-type">
                                    <option value="both">In cả hai (Hợp đồng + Nghiệm thu & Thanh lý)</option>
                                    <option value="contract">Chỉ in Hợp đồng mua bán</option>
                                    <option value="liquidation">Chỉ in Biên bản nghiệm thu & Thanh lý</option>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            app.querySelector('#con-b-select').onchange = (e) => {
                ...
                app.querySelector('#con-b-store').value = `ĐMM_${storeName.toUpperCase()}`;
            };
            ...
            app.querySelector('#btn-con-generate').onclick = () => {
                ...
                let printHtml = `
                    ...
                    <head>
                        ...
                        <style>
                            @media print {
                                body { width: 21cm; height: 29.7cm; margin: 1.5cm 1.5cm 1.5cm 2cm; font-family: "Times New Roman", Times, serif; font-size: 11pt; line-height: 1.35; color: #000; }
                                .page-break { page-break-after: always; }
                                .no-print { display: none; }
                            }
                            body { font-family: "Times New Roman", Times, serif; font-size: 11.5pt; line-height: 1.35; color: #000; padding: 40px; max-width: 800px; margin: auto; background:#fff;}
                            ...
                            .footer-note { border-top: 1px solid black; margin-top: 40px; padding-top: 5px; display: flex; justify-content: space-between; font-size: 9.5pt; font-weight: bold; }
                        </style>
                    </head>
                    <body>
                `;
                ...
                if (docType === 'both' || docType === 'liquidation') {
                    ...
                    printHtml += `
                        ...
                        <div class="page-break" style="font-family: 'Times New Roman', serif;">
                            ...
                            <!-- Footer thương hiệu đúng chuẩn PDF mẫu -->
                            <div style="border-top: 1px solid #ccc; margin-top: 220px; padding-top: 5px; display: flex; justify-content: space-between; font-size: 10pt; font-family: sans-serif;">
                        ...
                        <div class="page-break" style="font-family: 'Times New Roman', serif;">
                            ...
                            <!-- Footer thương hiệu đúng chuẩn PDF mẫu trang 2 -->
                            <div style="border-top: 1px solid #ccc; margin-top: 200px; padding-top: 5px; display: flex; justify-content: space-between; font-size: 10pt; font-family: sans-serif;">
                                <span style="font-weight: bold; color: #111;">dienmayxanh</span>
                                <span>2/2</span>
                            </div>
                        </div>
